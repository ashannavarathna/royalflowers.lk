...
CREATE TABLE `advertising` (
  ...
  `adds_num` varchar(45) DEFAULT NULL,
  `on_date` varchar(45) DEFAULT NULL,
  ...
  `advertising_idadvertising` int(11) NOT NULL,
  ...
  KEY `fk_advertising_company1` (`company_idcompanies`),
  KEY `fk_advertising_advertising1_idx` (`advertising_idadvertising`),
  KEY `fk_advertising_advertising_category1_idx` (`advertising_category_idadvertising_category`),
  CONSTRAINT `fk_advertising_advertising1` FOREIGN KEY (`advertising_idadvertising`) REFERENCES `advertising` (`idadvertising`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_advertising_advertising_category1` FOREIGN KEY (`advertising_category_idadvertising_category`) REFERENCES `advertising_category` (`idadvertising_category`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
-- Table structure for table `royal_flowers`.`advertising_category`
--

DROP TABLE IF EXISTS `advertising_category`;
CREATE TABLE `advertising_category` (
  `idadvertising_category` int(11) NOT NULL AUTO_INCREMENT,
  `category` varchar(45) NOT NULL,
  PRIMARY KEY (`idadvertising_category`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `royal_flowers`.`advertising_category`
--
...
CREATE TABLE `user` (
  ...
  `user_gender_idgender` int(11) NOT NULL,
