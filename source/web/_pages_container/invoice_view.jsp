...
<div style="width:980px;">
    ...
    <div class="admin_sub_content">
        ...
        <div class="a_field">
            ...
            <input type="submit" value="search" id="a_field_submit" onclick="load_invoice_with_params('postc', '_pages_container/invoice_view.jsp')">
        </div>
...
//                            }
        ...
        <div style="font-family: consolas;">
            <div style="margin-left: 30px;font-size: 20px;margin-top: 5px;"><span style="display: inline-block;width: 200px;">Purchase Amount </span> : <span style="display: inline-block;width: 150px;text-align: right;padding-right: 3px;"> <%=df.format(totlaamount)%></span>  </div>
            <div style="margin-left: 30px;font-size: 20px;margin-top: 5px;"><span style="display: inline-block;width: 200px;">Delivery Cost </span> : <span style="display: inline-block;width: 150px;text-align: right;padding-right: 3px;"> <%=df.format(dlvcost)%></span>  </div>
            <div style="margin-left: 30px;font-size: 20px;margin-top: 5px;"><span style="display: inline-block;width: 200px;">Invoice Total</span> : <span style="display: inline-block;width: 150px;text-align: right;padding-right: 3px;background-color: #333;color: #FFF;">  <%=df.format(total)%> </span> </div>
        </div>
