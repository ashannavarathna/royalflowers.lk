        ...
        <div class="main-wrapper">
            ...
            <div id="wrapper">
                <div id="header-wrapper">
                    <div id="header">
                        <div id="logo">
                            <h1><a href="user_profile.jsp"><%=ussssr.getFname() + " " + ussssr.getLname()%> </a></h1>
                            <p><%=ussssr.getEmail()%> </p>
                        </div>
                        <div id="menu">
                            <ul>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li onclick="load_a_html('postc', '_pages_container/usr_adviewer.jsp')">Advertising</li>
                                            <li id="usr_delivery_btn" onclick="load_a_html('postc', '_pages_container/delivery_usr.jsp')">Delivery</li>
                                            <li>Notification</li>
            ...
            <script type="text/javascript">
                ...
                function load_invoice_with_params(req_container, html_location) {
                    ...
                    xmlhttpreq.open("POST", html_location + "?search=v2k2" + urlpattern, true);
                    xmlhttpreq.setRequestHeader('Content-type', 'text/html');
                    xmlhttpreq.send();
                }
                        ...
                        if (flag_update) {
                            ...
                            xmlhttpreq.onreadystatechange = function () {
                                if (xmlhttpreq.readyState === 4 && xmlhttpreq.status === 200) {
                                    ...
                                    if (resultarr[0] === "1") {
                                        document.getElementById("crr_pass").value = "";
                                        document.getElementById("nw_pass").value = "";
                                        document.getElementById("cfm_pass").value = "";
            ...
            %>
            <div style="min-height: 300px; width: 500px;margin: 10px 0 0 100px;font-size: 13px;color: #d15;">Your account is not activated please activate <a href="email_verification.jsp">click here</a> or <a href="user_logout">logout</a></div>
            <%                }
                }
            %>
        </div>
